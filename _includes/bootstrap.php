...
include ROOTDIRECTORY_PATH.'_includes/parse_filetype.class.php';
include ROOTDIRECTORY_PATH.'_includes/make_lists.class.php';
include ROOTDIRECTORY_PATH.'_includes/make_posts.class.php';
